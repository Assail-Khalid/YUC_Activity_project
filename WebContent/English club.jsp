...
<hr>
         ...
         <!-- End of search bar code -->
             ...
             <%@ include file="/WEB-INF/includes/conutEnglish.jsp" %>
        ...
        <div class="container">
          <div class="content">
            <div>
              ...
              <p>
                English clubs come in many different guises.
                <br />
                we provide an opportunity for English language learners <br />to
