...
<% 
         ...
         // Send updated cookie
          response.addCookie(new Cookie ("Computer_club", String.valueOf(Computer_club)));

         // Output message
         if (Computer_club==0){}
         else{
          out.println("<h2 class='centered'> You Have Visited this page  " +Computer_club+" times"+"</h2>");
