...
<% 
         ...
         // Send updated cookie
          response.addCookie(new Cookie ("Talent_club", String.valueOf(Talent_club)));

         // Output message
         if (Talent_club==0){}
         else{
          out.println("<h2 class='centered'> You Have Visited this page  " +Talent_club+" times"+"</h2>");
