...
<% 
         ...
         // Send updated cookie
          response.addCookie(new Cookie ("Arty_club", String.valueOf(Arty_club)));

         // Output message
         if (Arty_club==0){}
         else{
          out.println("<h2 class='centered'> You Have Visited this page  " +Arty_club+" times"+"</h2>");
