  ...
  <body>
    ...
    <header>
      ...
      <!-- Search bar code -->
         ...
         <%@ include file="/WEB-INF/includes/countTalent.jsp" %>
    ...
    <section>
      <div class="announcment-section">
        <div class="container">
          <div class="content">
            ...
            <h2>Talent Club</h2>
            <p>
                Understand how your talents work with others.<br>
                share your talent with people <br>
                 make things happen, influence others and build relationships.
            </p>
          </div>
          </div>
      ...
      <div class="announcment-section">
        <img
          ...
          src="talent-invite.jpg"
          alt="Talent Club - announcement Activity"
        />
      </div>
      <div class="announcment-section">
        <img
